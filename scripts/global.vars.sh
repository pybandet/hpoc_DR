...
case "${OCTET[0]}.${OCTET[1]}" in
  ...
  10.42 ) # HPOC us-west = PHX
    PC_DEV_METAURL='http://10.42.194.11/workshop_staging/pcdeploy-pc.2021.1.json'
    PC_DEV_URL='http://10.42.194.11/workshop_staging/pc.2021.1.tar'
    PC_CURRENT_METAURL='http://10.42.194.11/workshop_staging/pcdeploy-pc.2020.11.json'
    PC_CURRENT_URL='http://10.42.194.11/workshop_staging/pc.2020.11.tar'
    PC_STABLE_METAURL='http://10.42.194.11/workshop_staging/pcdeploy-pc.2020.9.json'
    PC_STABLE_URL='http://10.42.194.11/workshop_staging/pc.2020.9.tar'
    FILES_METAURL='http://10.42.194.11/workshop_staging/afs-3.8.0.json'
    FILES_URL='http://10.42.194.11/workshop_staging/nutanix-afs-el7.3-release-afs-3.8.0-stable.qcow2'
    FILE_ANALYTICS_METAURL='http://10.42.194.11/workshop_staging/nutanix-file_analytics-el7.7-release-3.0.0-metadata.json'
